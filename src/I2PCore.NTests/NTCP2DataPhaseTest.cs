...
public class NTCP2DataPhaseTest
{
    ...
    public void TestNTCP2DataFrameParse()
    {
        ...
        for (var i = 0; i < 32; i++) sipKeys[i] = (byte)i;
        ...
        Assert.AreEqual(frameLength, parsedFrame.Length);
    ...
    public void TestNTCP2RouterInfoBlock()
    {
        ...
        var riBytes = File.ReadAllBytes(riPath);
        var ri = new I2PRouterInfo(new I2PBufferCursor(riBytes), false);

        var frame = NTCP2DataFrame.BuildWithRouterInfo(ri);
