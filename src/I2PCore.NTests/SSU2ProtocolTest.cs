...
namespace I2PTests
{
    ...
    public class SSU2ProtocolTest
    {
        ...
        public void TestFragmentAndReassemble()
        {
            ...
            byte[] result = handler.HandleFirstFragment( StripBlockHeader( fragments[0] ) );
        ...
        public void TestShortHeaderEncryptDecrypt()
        {
            ...
            for ( int i = 0; i < 16; i++ )
                if ( packet[i] != original[i] ) anyChanged = true;
        ...
        #region Payload Size Calculations
