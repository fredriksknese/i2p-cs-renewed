...
public class CryptoExtensionsTest
{
    ...
    {
        Assert.AreEqual(
            RouterContext.BandwidthClass.L,
            RouterContext.ParseBandwidthClass("L"));
        Assert.AreEqual(
            RouterContext.BandwidthClass.O,
            RouterContext.ParseBandwidthClass("O"));
        Assert.AreEqual(
            RouterContext.BandwidthClass.P,
            RouterContext.ParseBandwidthClass("P"));
        Assert.AreEqual(
            RouterContext.BandwidthClass.X,
            RouterContext.ParseBandwidthClass("X"));
        Assert.AreEqual(
            RouterContext.BandwidthClass.O,
            RouterContext.ParseBandwidthClass("invalid"),
    ...
    public void TestBandwidthClassValues()
    {
        ...
        Assert.AreEqual(32, (int)RouterContext.BandwidthClass.L);
        Assert.AreEqual(64, (int)RouterContext.BandwidthClass.M);
        Assert.AreEqual(128, (int)RouterContext.BandwidthClass.N);
        Assert.AreEqual(256, (int)RouterContext.BandwidthClass.O);
        Assert.AreEqual(2048, (int)RouterContext.BandwidthClass.P);
        Assert.AreEqual(0, (int)RouterContext.BandwidthClass.X);
    }
}