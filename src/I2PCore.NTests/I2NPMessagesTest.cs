...
public class I2NpMessagesTest
{
    ...
    private readonly I2PSigningPrivateKey PrivateSigningEd25519;
    private readonly I2PSigningPublicKey PublicSigningEd25519;
    private I2PRouterIdentity Me;
    ...
    public I2NpMessagesTest()
    {
        ...
        var certificateEd25519 = new I2PCertificate(I2PSigningKey.SigningKeyTypes.EdDsaSha512Ed25519);
    ...
    public void TestSimpleDatabaseStoreLeaseSetCreation()
    {
        ...
        var ls = new I2PLeaseSet(new I2PDestination(Public, PublicSigning), leases, Public, PublicSigning,
            PrivateSigning);
...
/*
    ...
    public void TestSimpleDatabaseStoreLeaseSetEd25519Creation()
    {
        ...
        var ls = new I2PLeaseSet(new I2PDestination(Public, PublicSigningEd25519), leases, Public, PublicSigningEd25519,
            PrivateSigningEd25519);
    ...
    public void VariableTunnelBuildMessageTest()
    {
        var msg = VariableTunnelBuildMessage.BuildInboundTunnel(
            new TunnelInfo(
                new List<HopInfo>
                {
                    new(new I2PDestination(Public, PublicSigning), BufUtils.RandomUint()),
                    new(new I2PDestination(Public, PublicSigning), BufUtils.RandomUint()),
                    new(new I2PDestination(Public, PublicSigning), BufUtils.RandomUint())
                }),
            new I2PIdentHash(true),
