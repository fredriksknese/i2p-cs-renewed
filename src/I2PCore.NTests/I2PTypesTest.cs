...
public class I2PTypesTest
{
    ...
    {
        var certificate = new I2PCertificate(I2PSigningKey.SigningKeyTypes.EdDsaSha512Ed25519);
    ...
    public void TestI2PLeaseSet2()
    {
        ...
        var ls = new I2PLeaseSet2(dest, leases, new[] { dest.PublicKey }, dest.SigningPublicKey,
