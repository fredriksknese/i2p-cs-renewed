...
namespace I2PCore
{
    public class FloodfillUpdater
    {
        ...
        private PeriodicAction StartNewUpdateRouterInfo = new( NetDb.RouterInfoExpiryTime / 5, true );
        private PeriodicAction CheckForTimouts = new( TickSpan.Seconds( 5 ) );
        ...
        private class FfUpdateRequestInfo
        {
            ...
            public static TimeWindowDictionary<I2PIdentHash,object> Exclude = new(TickSpan.Minutes(5));
        ...
        private TimeWindowDictionary<uint, FfUpdateRequestInfo> OutstandingRequests = new(TickSpan.Seconds(80));
        ...
        private static IEnumerable<I2PIdentHash> GetNewFfList( I2PIdentHash id, DateTime targetDate, int count, int samples, ICollection<I2PIdentHash> exclude )
        {
            var list = NetDb.Inst
                .GetClosestFloodfill(
                    id,
