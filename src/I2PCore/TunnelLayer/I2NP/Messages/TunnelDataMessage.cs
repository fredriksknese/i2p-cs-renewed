...
namespace I2PCore.TunnelLayer.I2NP.Messages
{
    public class TunnelDataMessage: I2NpMessage
    {
        ...
        private BufLen FirstDeliveryInstruction;
        ...
        public TunnelDataMessage( BufRef reader )
        {
        ...
        private static BufLen FindTheZero( BufLen start )
        {
        ...
        public I2PTunnelId TunnelId
        {
            get
            {
                return new I2PTunnelId( Payload.PeekFlip32( 0 ) );
            }
            set
            {
			...
			nexttunneldatablock:
                ...
                while ( datareader.Length > 0 )
	            {
                    ...
                    if ( datareader.Length <= freespace )
					{
                        ...
                        tunneldatabufferavailable -= FollowOnFragmentHeaderSize + datareader.Length;
