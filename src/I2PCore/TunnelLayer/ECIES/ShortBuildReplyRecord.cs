...
namespace I2PCore.TunnelLayer.ECIES
{
    ...
    public class ShortBuildReplyRecord
    {
        ...
        public bool IsAccepted() => Status == TunnelBuildReplyStatus.Accept;
        public bool IsRejected() => Status != TunnelBuildReplyStatus.Accept;
        ...
        public byte[] Encrypt(byte[] replyKey, byte[] replyIV)
        {
            ...
            return ChaCha20Poly1305.Encrypt(replyKey, nonce, plaintext, null);
        }
        ...
        public static ShortBuildReplyRecord Decrypt(byte[] ciphertext, byte[] replyKey, byte[] replyIV)
        {
            ...
            var plaintext = ChaCha20Poly1305.Decrypt(replyKey, nonce, ciphertext, null);
            if (plaintext == null) return null;
