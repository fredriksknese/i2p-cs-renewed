...
namespace I2PCore.TunnelLayer
{
    public class TunnelTester
    {
        ...
        private TimeWindowDictionary<Tunnel, TunnelTestResult> TestResults = new(TickSpan.Minutes(10));
        ...
        private ConcurrentQueue<OutboundTunnel> OutboundTunnels = new();
        private ConcurrentQueue<InboundTunnel> InboundTunnels = new();

        private TimeWindowDictionary<Tunnel, TestRun> OutstandingTests = new(MaxTestRunTime);

        private TimeWindowDictionary<uint, TestProbe> OutstandingProbeIds = new(MaxTestRunTime);
        ...
        private AutoResetEvent TunnelAdded = new( false );
