...
namespace I2PCore.SessionLayer
{
    ...
    public class EgaesSessionKeyOrigin
    {
        ...
        private TimeWindowDictionary<uint,SessionAndTags> NotAckedTags = new(UnAcKedTagLifetime);

        private TimeWindowDictionary<I2PSessionTag, I2PSessionKey> AckedTags = new(AcKedTagLifetime);
                    ...
                    IList<GarlicClove> cloves )
        {
            ...
            if ( pkey == null )
            {
                throw new InvalidOperationException( $"{this}: No ElGamal public key available for {RemoteDestination.Id32Short}" );
            }
