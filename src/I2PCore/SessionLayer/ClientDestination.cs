...
namespace I2PCore.SessionLayer
{
    public partial class ClientDestination : IClient
    {
        ...
        public int InboundTunnelCount { get => InboundEstablishedPool.Count; }
        public int OutboundTunnelCount { get => OutboundEstablishedPool.Count; }

        readonly protected ConcurrentDictionary<OutboundTunnel, byte> OutboundPending = new();
        readonly protected ConcurrentDictionary<InboundTunnel, byte> InboundPending = new();
        readonly protected ConcurrentDictionary<OutboundTunnel, byte> OutboundEstablishedPool = new();
        readonly protected ConcurrentDictionary<InboundTunnel, byte> InboundEstablishedPool = new();
        ...
        public Garlic DecryptGarlic( GarlicMessage msg ) => MySessions.DecryptMessage( msg );
        ...
        private PeriodicAction QueueStatusLog = new( TickSpan.Seconds( 15 ) );

        private PeriodicAction KeepClientStateUpdated = new( TickSpan.Seconds( 10 ) );
