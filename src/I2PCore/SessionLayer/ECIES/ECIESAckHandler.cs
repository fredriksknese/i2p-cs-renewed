...
public class ECIESAckHandler
{
    ...
    public void CleanupExpired()
    {
        ...
        foreach (var messageId in expired) _pendingMessages.TryRemove(messageId, out _);
        ...
        foreach (var dest in expiredStates) _destinationStates.TryRemove(dest, out _);
    }
...
public class AckStatistics
{
    ...
    {
        return
            $"ACK Stats: Pending={PendingMessages}, Destinations={TrackedDestinations}, Retrans={TotalRetransmissions}";
    }
}