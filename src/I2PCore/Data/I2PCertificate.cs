...
public class I2PCertificate : I2PType
{
    ...
    private readonly int NotImplementedPublicKeyLength;
    ...
    public I2PCertificate(I2PKeyType.KeyTypes keytype, int keylen = -1)
    {
    ...
    public CertTypes CType
    {
        get => (CertTypes)Data[0];
    ...
    public I2PKeyType.KeyTypes KeyPublicKeyType
    {
        get
        {
    ...
    {
        get => Data.ReadUInt16BigEndian(1);
        protected set => Data.WriteUInt16BigEndian(value, 1);
    }

    public I2PByteBlock Payload => new(Data.BaseArray, Data.BaseArrayOffset + 3, PayloadLength);
    ...
    public int CertLength => 3 + PayloadLength;
    ...
    public int PrivateKeyLength => I2PKeyType.PrivateKeyLength(PublicKeyType);
    ...
    public int RouterIdentitySize => PublicKeyLength + 128 + CertLength;
