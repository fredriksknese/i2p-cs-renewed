...
public class I2PRoutingKey : I2PType
{
    ...
    public I2PByteBlock Hash
    {
        get
        {
            ...
            HashCache = new I2PByteBlock(I2PHashSha256.GetHash(Identity.Hash,
                new I2PByteBlock(GenerateDtBuf(TargetDate))));
    ...
    public static I2PByteBlock operator ^(I2PIdentHash left, I2PRoutingKey right)
    {
        ...
        for (var i = 0; i < 32; ++i) result[i] = (byte)(lhash[i] ^ rhash[i]);
