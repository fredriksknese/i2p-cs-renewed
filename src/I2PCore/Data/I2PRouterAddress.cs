    ...
    public class I2PRouterAddress : I2PType
    {
        ...
        { 
            get 
            {
                ...
                {
                    if ( !Options.TryGet( "h", out hoststr ) ) return null;
                }
        ...
        public bool HaveHostAndPort { get { return ( Options.Contains( "host" ) || Options.Contains( "h" ) ) && ( Options.Contains( "port" ) || Options.Contains( "p" ) ); } }
