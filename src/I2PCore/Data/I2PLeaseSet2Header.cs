...
public class I2PLeaseSet2Header : I2PType
{
    ...
    {
        if (dest is null || published is null) throw new ArgumentException("Null argument not supported");
        Destination = dest;
        Published = published;
        Flags = flags;
    ...
    public void Write(IBufferWriter<byte> dest)
    {
        ...
        if (Flags.HasFlag(HeaderFlagTypes.OfflineKey)) OfflineSignature?.Write(dest);
    }
}