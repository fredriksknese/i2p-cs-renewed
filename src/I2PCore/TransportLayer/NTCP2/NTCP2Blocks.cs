...
namespace I2PCore.TransportLayer.NTCP2
{
    ...
    public class NTCP2OptionsBlock : NTCP2Block
    {
        ...
        public byte TMin { get; set; } = 0;
        public byte TMax { get; set; } = 0;
        public byte RMin { get; set; } = 0;
        public byte RMax { get; set; } = 0;

        // Dummy traffic (bytes/sec)
        public ushort TDummy { get; set; } = 0;
        public ushort RDummy { get; set; } = 0;

        // Max delay (msec)
        public ushort TDelay { get; set; } = 0;
        public ushort RDelay { get; set; } = 0;
