...
namespace I2PCore.TransportLayer
{
    ...
    public class TimestampValidator
    {
        ...
        public TimestampValidator(int maxClockSkewSeconds = 60, int replayCacheMinutes = 10)
        {
            ...
            this.replayCacheLifetime = TimeSpan.FromMinutes(replayCacheMinutes);
            this.replayCache = new ConcurrentDictionary<string, DateTime>();
        }
        ...
        public void CleanupReplayCache()
        {
            ...
            if (toRemove.Count > 0)
            {
                Logging.LogDebug($"Cleaned up {toRemove.Count} expired replay cache entries");
            }
        }
