...
namespace I2PCore.Utils
{
    ...
    {
        private long PositionField = 0;
        private long LengthField = 0;

        private LinkedList<BufRefLen> Bufs = new();
        ...
        public override long Position { get => PositionField; set => throw new NotSupportedException( "BufRefStream is forward-only and does not support seeking." ); }
        ...
        {
            throw new NotSupportedException( "BufRefStream is forward-only and does not support seeking." );
        }

        public override void SetLength( long value )
        {
            throw new NotSupportedException( "BufRefStream does not support SetLength." );
        }
