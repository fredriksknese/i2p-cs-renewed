...
namespace I2PCore.Utils
{
    ...
    public class UPnp
    {
        private EndPoint MsEp;
        private EndPoint MlEp;
        private Socket MulticastSocket;

        private const int LeaseMapDurationSeconds = 60 * 60 * 2;

        private Dictionary<string, HttpResponse> WanipConnections = new();
        private Dictionary<string, ControlInfo> WanipConnectionsCtlInfo = new();
        ...
        private PeriodicAction DiscoverAction = new( TickSpan.Minutes( 15 ) );
        private PeriodicAction ExternalPortMappingAction = new( TickSpan.Seconds( 0 ) );
        private void Run()
        {
        ...
        private int GetInitialPort()
        {
            ...
            try { return SessionLayer.RouterContext.Inst?.TcpPort ?? 6359; }
            catch { return 6359; }
        }
