...
namespace I2PCore.Utils
{
    ...
    public class BufLen : BufBase, IEnumerable<byte>, IList<byte>, IEquatable<BufLen>, IComparable<BufLen>
    {
        ...
        private readonly int LengthDef;
        ...
        {
            throw new NotSupportedException( "BufLen is a fixed-size buffer view and does not support insertion." );
        }

        void IList<byte>.RemoveAt( int index )
        {
            throw new NotSupportedException( "BufLen is a fixed-size buffer view and does not support removal." );
        }
        ...
        {
            throw new NotSupportedException( "BufLen is a fixed-size buffer view and does not support Add." );
        }

        void ICollection<byte>.Clear()
        {
            throw new NotSupportedException( "BufLen is a fixed-size buffer view and does not support Clear." );
        }
        ...
        {
            throw new NotSupportedException( "BufLen is a fixed-size buffer view and does not support Remove." );
        }
