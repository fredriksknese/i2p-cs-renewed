...
public class I2Phmacmd5Digest
{
    ...
    private static readonly byte[] Ipadbuf =
    {
    ...
    private static readonly byte[] Opadbuf =
    {
    ...
    private static readonly byte[] Nullpad = new byte[16];

    public static byte[] Generate(I2PByteBlock msg, I2PByteBlock key)
    {
        return Generate(new[] { msg }, key);
    }
    ...
    public static I2PByteBlock Generate(IEnumerable<I2PByteBlock> msg, I2PByteBlock key, I2PByteBlock dest)
    {
        ...
        if (dest.Length < m5.GetDigestSize())
            throw new OverflowException("Not enough dest buffer size for I2PHMACMD5Digest.Generate()!");
