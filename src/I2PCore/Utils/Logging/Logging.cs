...
namespace I2PCore.Utils
{
    ...
    {
        private static ILogStore _store = null;
        ...
        private static PeriodicAction _checkFileRotation = new( TickSpan.Minutes( 1 ) );
        private static readonly char[] TrimEndChars = new char[] { '\r', '\n', ' ', '\t' };
