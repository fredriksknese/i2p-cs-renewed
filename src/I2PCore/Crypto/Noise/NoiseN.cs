        ...
        if (isInitiator)
        {
            ...
            if (remoteStaticPublicKey.Length != 32)
                remoteStaticPublicKey =
                    remoteStaticPublicKey.Skip(remoteStaticPublicKey.Length - 32).Take(32).ToArray();
        ...
        else
        {
            ...
            if (localStaticPrivateKey.Length != 32)
                localStaticPrivateKey =
                    localStaticPrivateKey.Skip(localStaticPrivateKey.Length - 32).Take(32).ToArray();
...
public static class NoiseNTunnelBuilder
{
        ...
        byte[] hopPublicKey)
    {
        ...
        var keyMaterial = HKDF.DeriveKey(
            null,
            sharedSecret,
            Encoding.ASCII.GetBytes("tunnel-reply"),
            64);
