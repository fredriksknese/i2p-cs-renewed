...
namespace I2PCore.Crypto.MLKEM
{
    ...
    public class MLKEM1024
    {
        ...
        {
            var publicKeyParams = (MLKemPublicKeyParameters)
                MLKemPublicKeyParameters.FromEncoding(MLKemParameters.ml_kem_1024, publicKey);
        ...
        {
            var privateKeyParams = (MLKemPrivateKeyParameters)
                MLKemPrivateKeyParameters.FromEncoding(MLKemParameters.ml_kem_1024, secretKey);
