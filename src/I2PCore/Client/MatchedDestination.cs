...
namespace I2PCore.Client
{
    ...
    public class MatchedDestination : IDisposable
    {
        ...
        private ILeaseSet _remoteLeaseSet;
        ...
        /// </summary>
        public I2PIdentHash RemoteIdentHash => _remoteIdentHash;

        /// <summary>
        /// Get the current remote lease set, or null if not yet resolved.
        /// </summary>
        public ILeaseSet RemoteLeaseSet => _remoteLeaseSet;
        ...
        private void ResolveRemote()
        {
            try
            {
                ...
                if (_remoteIdentHash != null)
                {
                    var ls = NetDb.Inst.FindLeaseSet(_remoteIdentHash);
                    if (ls != null)
                    {
                        _remoteLeaseSet = ls;
