...
internal class EstablishedState : I2CpState
{
            ...
            switch (msg)
            {
                ...
                case DestLookupMessage dlum:
                    ...
                    Session
                        ...
                        .Value
                        .MyDestination
                        .LookupDestination(dlum.Ident, HandleDestinationLookupResult);
                    break;
                ...
                case SendMessageExpiresMessage smem:
                    Logging.LogDebugData(
                        $"{this}: {smem} {smem.Destination.IdentHash.Id32Short} {(PayloadFormat)smem.Payload[9]} {smem.Payload}");
    ...
    private void HandleHostLookupResult(I2PIdentHash hash, ILeaseSet ls, object o)
    {
        ...
        Logging.LogDebug(
            $"{this} HandleDestinationLookupResult: {hlinfo.SessionId} {hlinfo.RequestId} {hash.Id32Short} '{ls}'");
    ...
    private void HandleDestinationLookupResult(I2PIdentHash hash, ILeaseSet ls, object o)
    {
        if (Session.Terminated) return;
